...
(library (core with-syntax)
  (export with-syntax)
  (import (for (core bootstrap) run expand))
...
(library (core syntax-rules)
  (export syntax-rules)
  (import (for (core bootstrap)   expand run) 
...
(library (core identifier-syntax)
  ...
  (import (for (core bootstrap) expand run (meta -1)))  ; since generated macro contains (syntax set!) at level 0
...
(library (r6rs)         
  ...
  (import (for (r6rs base)         run expand)
