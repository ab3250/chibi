/*
  ...
  ../src/gengetopt --gen-version --input=test_conf_parser_cmd.ggoconf --func-name=test_conf_parser_cmd_parser --file-name=test_conf_parser_cmd --unnamed-opt=OTHER NAMES --conf-parser --arg-struct-name=my_args_info --no-handle-error 
